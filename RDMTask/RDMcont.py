...
# Setup the Window
win = visual.Window(
    size=[600, 600], fullscr=True, screen=1, 
...
if expInfo['frameRate'] != None and expInfo['frameRate'] != 0:
...
coherentTrials = data.TrialHandler(nReps=10.0, method='fullRandom', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('coherent_conditions.xlsx'),
